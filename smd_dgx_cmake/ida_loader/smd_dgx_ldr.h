...
// Sega Genesis / Mega Drive ROM loader.
// Ported from smd_ida_tools2 (sega_roms_ldr, DrMefistO [Lab 313]) to the
// IDA 9.2+ SDK and this project's build. Creates the segment layout, header
// and vector-table definitions the SMD DGX debugger expects.

#define LDR_VERSION "2.1"
